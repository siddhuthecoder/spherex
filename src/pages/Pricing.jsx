...
const additionalServices = [
  {
    ...
    description: 'Add online store functionality to your website',
    price: 999,
    popular: true
  },
  {
...
const faqs = [
  {
    ...
    answer: 'We accept all major credit cards (Visa, Mastercard, American Express), PayPal, and bank transfers. For enterprise clients, we also accept checks and can provide custom payment terms.'
  },
  {
    question: 'Can I upgrade or downgrade my plan later?',
    answer: 'Yes, you can upgrade or downgrade your plan at any time. Your account will be credited or charged the prorated difference for the current billing cycle.'
  },
  {
    question: 'Is there a money-back guarantee?',
    answer: 'We offer a 30-day money-back guarantee on all our plans. If you\'re not satisfied with our service, you can request a full refund within 30 days of your initial purchase.'
  },
  {
    question: 'Do you offer discounts for non-profits?',
    answer: 'Yes, we offer special pricing for registered non-profit organizations. Please contact our sales team with proof of your non-profit status to learn more about our discounted rates.'
  },
  {
    question: 'What happens if I exceed my plan limits?',
    answer: "If you exceed your plan limits, we'll notify you and work with you to either upgrade your plan or optimize your usage. We'll never charge you overages without your explicit approval."
  }
];
  ...
  return (
    <div className="border-b border-gray-100 py-6">
      <button
        ...
        onClick={onClick}
      >
        <span className="text-lg pr-4 group-hover:text-indigo-600 transition-colors">{question}</span>
        <motion.div
          animate={{ rotate: isOpen ? 180 : 0 }}
          transition={{ duration: 0.3 }}
        >
          <ChevronDownIcon className="w-5 h-5 text-gray-400 group-hover:text-indigo-600 transition-colors" />
        </motion.div>
      </button>
      <AnimatePresence>
        {isOpen && (
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden ">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <span className="inline-block px-4 py-1.5 text-xs font-semibold bg-white/10 backdrop-blur-md  rounded-full mb-6 border border-white/10 shadow-sm">
              Pricing Plans
            </span>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">Flexible Pricing for Every Business</h1>
            <p className="text-lg leading-relaxed max-w-2xl mx-auto">
              Discover plans tailored to your needs with transparent pricing and no hidden fees.
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {plans.map((plan, index) => {
              ...
              return (
                <motion.div 
                  key={plan.name}
                  className={`relative rounded-2xl overflow-hidden transition-all duration-300 bg-white border ${
                    isSelected ? 'ring-2 ring-indigo-500 shadow-xl' : 'border-gray-100 shadow-sm'
                  } ${plan.mostPopular ? 'md:-translate-y-4' : ''}`}
                ...
                >
                  {plan.mostPopular && (
                    <div className="absolute  top-0 right-0 mt-2 transform -translate-x-1/2  bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xs font-semibold uppercase tracking-wide py-2 px-6 rounded-full shadow-md ">
                      Most Popular
                    </div>
                  )}
                  ...
                  <div className="p-8">
                    ...
                    <div className="mb-6">
                      ...
                      {billingCycle === 'yearly' && (
                        <div className="text-xs text-gray-400 line-through mt-1">${plan.price * 12}/year</div>
                      )}
                    </div>
                    ...
                    <div className="mt-8 space-y-3">
                      {plan.features.map((feature, i) => (
                        <div key={i} className="flex items-start">
                          <div className="bg-indigo-50 p-1 rounded-full mr-3 mt-0.5">
          ...
          <div className="mt-12 text-center">
            ...
            <button className="mt-4 inline-flex items-center text-indigo-600 font-medium hover:text-indigo-800 transition-colors group">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-2xl mx-auto">
              Customize your plan with these powerful add-ons for a complete solution.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {additionalServices.map((service, index) => {
              ...
              return (
                <motion.div 
                  key={service.name}
                  className={`border rounded-xl p-6 transition-all duration-300 bg-white ${
                    isSelected ? 'border-indigo-500 bg-indigo-50/50 shadow-md' : 'border-gray-100 hover:border-indigo-200 hover:shadow-sm'
                  }`}
                  whileHover={{ y: -4, boxShadow: "0 6px 12px rgba(0,0,0,0.05)" }}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div className="mb-4 md:mb-0">
                ...
                <p className="text-sm text-gray-600">
                  {selectedPlan ? `1 x ${selectedPlan.name} Plan` : 'No plan selected'}
                  {selectedServices.length > 0 && ` + ${selectedServices.length} add-ons`}
                </p>
              </div>
                ...
                <div className="text-right">
                  ...
                  {billingCycle === 'yearly' && selectedPlan && (
                    <p className="text-xs text-emerald-600 font-medium">
                      You save ${Math.floor(selectedPlan.price * 12 * 0.2)} with annual billing
                    </p>
                  )}
                </div>
                
                <button className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium rounded-lg shadow-md hover:from-indigo-600 hover:to-purple-600 transition-all duration-300">
                  Proceed to Checkout
                </button>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <span className="inline-block px-3 py-1 text-xs font-semibold text-indigo-600 bg-indigo-50 rounded-full mb-4">FAQs</span>
