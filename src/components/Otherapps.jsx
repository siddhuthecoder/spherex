...
>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-center text-center relative  bg-cover bg-center bg-no-repeat"   style={{ backgroundImage: "url('/OTHERAPPS.png')" }}
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              ...
              <div className="border border-purple-900 p-8 rounded-full shadow-2xl scale-75 md:scale-100 absolute w-24 h-24  glow-expand-animation"></div>
                <div className="border border-purple-900 rounded-full w-16 h-16 flex items-center justify-center relative glow-expand-animation">
