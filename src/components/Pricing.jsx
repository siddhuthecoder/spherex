...
const Pricing = () => {
  return (
    <div className="relative w-full md:h-[180vh]  mx-auto p-8 rounded-xl text-white md:mt-0 mt-[400px] md:overflow-hidden flex flex-col-reverse md:flex-col items-center  font-jost"
      >
