...
const Pricing = () => {
  return (
    <div className="relative w-full mx-auto p-8 rounded-xl text-white my-[40px] overflow-hidden flex flex-col items-center"
      >
        <img src="PRICING.png" alt="" className='scale-[0.6]' />
      ...
      <div class="px-2 py-1 rounded-full text-md font-medium border border-violet-400  hover:text-white transition-all duration-300 shadow-[inset_0_0_15px_rgba(168,85,247,0.7)] w-[120px] mx-auto">
                Get Access
                    ...
                    <p className="text-gray-300 text-5xl font-semibold mt-[20px] leading-normal">We like keeping things simple</p>
        <p className="text-gray-300 text-5xl font-semibold ">One plan one price.</p>
      </div>
