...
export default function Navbar() {
  ...
  return (
    <div className=''>
    <nav className="flex justify-between items-center  px-3 md:px-[100px] py-5  backdrop-blur-md fixed top-0 z-50 w-full font-jost before:content-[''] before:absolute before:bottom-1 before:left-0 before:w-full before:h-[1px] before:pointer-events-none 
   ...
   <div className="hidden absolute md:flex gap-4 text-[16px] items-center h-[42px] p-[7px_20px] rounded-full border border-white/10 bg-white/5 left-1/2 transform -translate-x-1/2 m-auto">
