...
const Hero = () => {
  ...
  return (
    <div className="hero relative w-full md:min-h-screen font-jost overflow-hidden">
      {/* Centered Heading */}
      ...
      <div className="hero-black-hole">
        ...
        <div className="hero-video absolute bottom-[-310px]  w-full md:h-screen h-[600px] mt-[-150px] md:mt-[-120px]">
