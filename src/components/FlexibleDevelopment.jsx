...
const FlexibleDevelopment = () => {
    return (
        <div className="p-8 w-full min-h-screen relative font-jost z-10 bg-[black]">
            {/* Main Heading */}
            <h1 className="md:text-4xl text-[24px] font-extrabold mb-12 flex items-center justify-center text-center bg-gradient-to-b from-white to-white/70 bg-clip-text text-transparent animate-scale-in tracking-tight drop-shadow-lg transition-all duration-500 hover:scale-105">
                <span className="md:mr-1 text-[24px] md:text-3xl text-purple-400 transition-transform duration-500 hover:rotate-12">🚀</span> Why Flexible Development is Better Than Full-Time Hiring?
            </h1>
            <div className="relative group grid grid-cols-1 md:grid-cols-2 gap-6
                ...
                <div className="relative animate-fade-in border-l-4 border-l-[#ffffff3d] p-8 backdrop-blur-md bg-[#100D20]/40 rounded-xl shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 cursor-pointer 
                    ...
                    <h2 className="text-2xl font-bold mb-6 text-white animate-slide-in tracking-wide drop-shadow-md">THE PROBLEM</h2>
                    <ul className="space-y-4 text-lg">
                        {[
                            ...
                            >
                                <span className="text-purple-400 mr-3 text-xl transition-transform duration-300 hover:scale-110">✔</span>
                ...
                <div className="relative animate-fade-in border-l-4 border-l-[#ffffff3d] p-8 backdrop-blur-md bg-[#100D20]/40 rounded-xl shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 cursor-pointer 
                    ...
                    before:content-[''] before:absolute before:w-[4px] before:h-[20px] before:left-[-2px] before:top-[100px] before:bg-[#ffffff3d] before:rounded">
                    <h2 className="text-2xl font-bold mb-6 text-white animate-slide-in tracking-wide drop-shadow-md">THE SOLUTION</h2>
                    <ul className="space-y-4 text-lg">
                        {[
